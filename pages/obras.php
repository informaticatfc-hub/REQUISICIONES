            ...
            <div class="container page-shell ">
                <div class="page-hdr">
                    <div class="page-hdr-left">
                        <h2 class="page-title">{{this.obras[0].obras_nombre}}</h2>
                        <p class="page-lead">Selecciona el modulo con el que deseas trabajar en esta obra.</p>
                ...
                <div class="obras-hero-grid">
                    <div class="quick-tile">
                        <span class="quick-tile-label">Nombre</span>
                        <span class="quick-tile-value small">{{this.obras[0].obras_nombre}}</span>
                    </div>
                    <div class="quick-tile">
                        <span class="quick-tile-label">Modulos</span>
                        <span class="quick-tile-value">2</span>
                    </div>
                    <div class="quick-tile">
                        <span class="quick-tile-label">Obras Recientes</span>
                        <span class="quick-tile-value">{{obrasLista.length}}</span>
                    </div>
                </div>
                <div class="module-grid">
                    <button type="button" class="module-card" @click="enterPresiones">
                        <div class="module-card-icon">
                            <img src="../images/icons/presiones.svg" alt="presiones">
                        </div>
                        <span class="module-card-label">Presiones</span>
                        <span class="module-card-sub">Gestiona las presiones de pago de la obra</span>
                    </button>
                    <button type="button" class="module-card" @click="enterRequisiciones">
                        <div class="module-card-icon">
                            <img src="../images/icons/requisiciones.svg" alt="requisiciones">
                        </div>
                        <span class="module-card-label">Requisiciones</span>
                        <span class="module-card-sub">Crea y consulta las requisiciones de compra</span>
                    </button>
                </div>
            </div>
        </div>

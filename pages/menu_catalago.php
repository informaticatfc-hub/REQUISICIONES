...
<body class="app-layout">
            ...
            <div class="container page-shell ">
                <div class="page-hdr">
                    <div class="page-hdr-left">
                        ...
                        <p class="page-lead">Administra la informacion base del sistema: proveedores, bancos y otros catalogos.</p>
                    </div>
                </div>
                <div class="module-grid">
                    <button type="button" class="module-card" @click="IrCatalagoProveedor">
                        <div class="module-card-icon">
                            <img src="../images/icons/supplier.svg" alt="proveedores">
                        </div>
                        <span class="module-card-label">Proveedores</span>
                        <span class="module-card-sub">Consulta y gestiona el catalogo de proveedores</span>
                    </button>
                    <button type="button" class="module-card" @click="irCatalagoBanco" v-if="users.length">
                        <div class="module-card-icon">
                            <img src="../images/icons/bank.svg" alt="bancos">
                        </div>
                        <span class="module-card-label">Bancos</span>
                        <span class="module-card-sub">Administra los bancos registrados en el sistema</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <!-- scripts constume-->
    <script src="../assets/js/menu_catalagos.js"></script>

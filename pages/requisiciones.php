...
<body class="app-layout">
            ...
            <div class="container page-shell overflow-auto page-content">
                <div class="page-hdr">
                    <div class="page-hdr-left">
                        <h2 class="page-title">Requisiciones &mdash; {{this.obras[0].obras_nombre}}</h2>
                        <p class="page-lead">Consulta y gestiona las requisiciones de la obra.</p>
                        <div class="obras-chip mt-2">
                            <span class="obras-chip-dot"></span>
                            Operacion activa
                        </div>
                    </div>
                    <div class="page-hdr-right" v-if="this.users.length && this.users[0].user_editReq == 1">
                        <button type="button" class="btn btn-success" @click="addRequisicion">Agregar Requisicion</button>
                    </div>
                </div>
                <div class="ops-hero-grid">
                    <div class="quick-tile">
                        <span class="quick-tile-label">Total Requisiciones</span>
                        <span class="quick-tile-value">{{requisiciones.length}}</span>
                    </div>
                    <div class="quick-tile">
                        <span class="quick-tile-label">Abiertas</span>
                        <span class="quick-tile-value">{{requisiciones.filter(r => r.requisicion_estatus === 'ABIERTO').length}}</span>
                    </div>
                    <div class="quick-tile">
                        <span class="quick-tile-label">Cerradas</span>
                        <span class="quick-tile-value">{{requisiciones.filter(r => r.requisicion_estatus === 'CERRADO').length}}</span>
                    </div>
                </div>
    ...
    <!-- scripts constume-->
    <script src="../assets/js/requisiciones.js"></script>

            ...
            <div class="container page-shell overflow-auto page-content">
                <div class="page-hdr">
                    <div class="page-hdr-left">
                        <h2 class="page-title">Catalogo de Proveedores</h2>
                        <p class="page-lead">Gestiona los proveedores registrados: consulta, edita y administra su estatus.</p>
                    ...
                    <div class="page-hdr-right" v-if="this.users.length && this.users[0].user_createPresion == 1">
                        <button type="button" class="btn btn-success" @click="addProvedores">
                            Agregar Proveedor
                        </button>
                    </div>
                </div>
                <div class="ops-hero-grid">
                    <div class="quick-tile">
                        <span class="quick-tile-label">Total Proveedores</span>
                        <span class="quick-tile-value">{{proveedores.length}}</span>
                    </div>
                    <div class="quick-tile">
                        <span class="quick-tile-label">Activos</span>
                        <span class="quick-tile-value">{{proveedores.filter(p => p.proveedor_estatus === 'ACTIVO').length}}</span>
                    </div>
                    <div class="quick-tile">
                        <span class="quick-tile-label">Inactivos</span>
                        <span class="quick-tile-value">{{proveedores.filter(p => p.proveedor_estatus === 'INACTIVO').length}}</span>
                    </div>
                </div>

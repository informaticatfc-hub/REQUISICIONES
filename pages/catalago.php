...
<head>
    ...
    <title>CATALAGOS :: The Fuentes Corporation</title>
</head>
        ...
        <div class="d-flex flex-column flex-shrink-0 h-100 position-fixed top-0 end-0 app-main">
            ...
            <nav class="nav shadow-sm d-flex align-items-center" id="navtab" aria-label="breadcrumb" aria-current="page">
                <ol class="breadcrumb py-2 px-3 my-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><span>Catalogos</span></li>
                </ol>
            </nav>
            <div class="container page-shell overflow-auto page-content">
                <div class="page-hdr">
                    <div class="page-hdr-left">
                        <h2 class="page-title">Centro de Catalogos</h2>
                        <p class="page-lead">Gestiona la informacion base del sistema y navega a los catalogos disponibles.</p>
                    </div>
                </div>
                <div class="row view-section">
                    <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                        <a class="quick-tile quick-tile-action h-100 text-decoration-none" href="./menu_catalago.php">
                            <span class="quick-tile-label">Ir al menu de catalogos</span>
                            <span class="quick-tile-value small">Proveedores, bancos y catalogos complementarios</span>
                        </a>
                    </div>
                    <div class="col-12 col-lg-6">
                        <div class="quick-tile h-100">
                            <span class="quick-tile-label">Obras disponibles</span>
                            <span class="quick-tile-value">{{obras.length}}</span>
                            <small class="text-muted">Puedes abrir una obra desde el menu lateral para consultar su detalle.</small>
                        </div>
                    </div>
                </div>
            </div>
